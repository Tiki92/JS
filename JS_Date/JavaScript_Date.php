      ...
      Show Code
        ...
        Show Code
						...
						<div class="function1">
							...
							<form class="form1" action="index.html" method="post">
								Enter the Month : <input type="number" id="month_getDaysInMonth"><br> Enter the Year : <input type="number" id="year_getDaysInMonth">
							</form>
        ...
        Show Code
						...
						<div class="function1">
							...
							<form class="form1" action="index.html" method="post">
								Enter first Date : <input type="date" id="date1_compare_date"><br> Enter second Date : <input type="date" id="date2_compare_date">
							</form>
        ...
        Show Code
						...
						<div class="function1">
							...
							<form class="form1" action="index.html" method="post">
								Enter first date : <input type="date" id="date1_date_diff_indays"><br> Enter second date : <input type="date" id="date2_date_diff_indays">
							</form>
