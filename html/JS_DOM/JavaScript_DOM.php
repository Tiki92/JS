				...
				<div class="col-sm-5">
					...
					<div class="main">
						...
						<div class="function1">
							...
							<div>
								<button id="style1" class="btn btn-primary" onclick="js_style()">Style</button>
        ...
        Show Code
          ...
          Show Code
						...
						<div class="function1">
							...
							<button id="jsstyle" class="btn btn-primary" onclick="display_random_image();">Show Image</button>
