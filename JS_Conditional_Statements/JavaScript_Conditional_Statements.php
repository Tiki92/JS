      ...
      <div class="main">
        ...
        <div class="function1">
          ...
          <form class="form1" action="index.html" method="post">
            Enter the first Number : <input type="number" id="number1_theBigger"><br>
            Enter the second Number : <input type="number" id="number2_theBigger">
          </form>
        ...
        <div class="function1">
          ...
          <form class="form1" action="index.html" method="post">
            Enter the first Number : <input type="number" id="num1_whatSign"><br>
            Enter the second Number : <input type="number" id="num2_whatSign"><br>
            Enter the third Number : <input type="number" id="num3_whatSign">
          </form>
