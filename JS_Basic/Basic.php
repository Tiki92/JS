   ...
   <div class="row">
    <div class="col-sm-3">
      ...
      <ul>
        ...
        <li><a href = "/JS_Recursion/JavaScript_Recursion.html"> JavaScript Recursion</a></li>
        <li><a href = "/JS_Conditional_Statements/JavaScript_Conditional_Statements.html">JavaScript Conditional Statements</a></li>
        <li><a href = "/JS_Array/JavaScript_Array.html">JavaScript Array</a></li>
        <li><a href = "/JS_Date/JavaScript_Date.html">JavaScript Date</a></li>
        <li><a href = "/JS_String/JavaScript_String.html">JavaScript String</a></li>
        <li><a href = "/JS_Math/JavaScript_Math.html">JavaScript Math</a></li>
        <li><a href = "/JS_Validation_with_Regular_Expression/JavaScript_Regular_Expression.html">JavaScript Validation with Regular Expression</a></li>
        <li><a href = "/JS_DOM/JavaScript_DOM.html">JavaScript DOM</a></li>
        <li><a href = "/JS_Drawing/JavaScript_Drawing.html">JavaScript Drawing</a></li>
        <li><a href = "/JS_Object/JavaScript_Object.html">JavaScript Object</a></li>
        <li><a href = "/JS_Validation/JavaScript_Validation.html">JavaScript Validation</a></li>
        <li><a href = "/JS_Searching_Sorting/JavaScript_Searching_Sorting.html">JavaScript Searching and Sorting</a></li>
      </ul>
    </div>
    ...
    <p id="toCel"></p>
      ...
      <div id="Compute_integers">
        <form class="compute_int" action="index.html" method="post">
          Input the value of X : <input type="number" id="cmp_1"><br>
          Input the value of Y : <input type="number" id="cmp_2">
        </form>
    ...
    <p id="the_sum"></p>
     ...
     <p id="19"></p>
      ...
      <div id="if_50">
        ...
        <form class="50_form">
        Number  : <input type="number" id="fst_num"><br>
        Number2:<input type="number" id="scd_num">
      </form>
      <p></p>
  ...
  <p id="50_this"></p>
    ...
    <p id="slow"></p>
      ...
      <div id="pos_neg">
        ...
        <form class="pos_neg_form" action="index.html" method="post">
          Enter a Number1 : <input id="pos_neg_num1"><br>
          Enter a Number2 : <input id="pos_neg_num2">
        </form>
    ...
    <p id="result_check"></p>
      ...
      <div id="remove_character_string">
        ...
        <form class="remove_letter" action="index.html" method="post">
          Input the Word : <input type="text" id="word_to_remove"> <br>
          Input the number of the letter to remove : <input type="text" id="number_letter">
        </form>
    ...
    <p id="result_start_spec_str"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="number1_check_numbers"><br>
          Number2 : <input type="number" id="number2_check_numbers">
        </form>
    ...
    <p id="result_check_numbers"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_check_3"><br>
          Number2 : <input type="number" id="num2_check_3"><br>
          Number3 : <input type="number" id="num3_check_3">
        </form>
    ...
    <p id="result_check_script"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_max_of_three"><br>
          Number2 : <input type="number" id="num2_max_of_three"><br>
          Number3 : <input type="number" id="num3_max_of_three">
        </form>
    ...
    <p id="result_max_of_three"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_near_100"><br>
          Number2 : <input type="number" id="num2_near_100">
        </form>
    ...
    <p id="result_near_100"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_numbers_ranges"><br>
          Number2 : <input type="number" id="num2_numbers_ranges">
        </form>
    ...
    <p id="result_numbers_ranges"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_max_townums_range"><br>
          Number2 : <input type="number" id="num2_max_townums_range">
        </form>
    ...
    <p id="result_max_townums_range"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
        Enter a Word : <input type="text" id="word_check_char"><br>
        Enter a Letter : <input type="text" id="char_check_char">
        </form>
    ...
    <p id="result_check_char"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_last_digit"><br>
          Number2 : <input type="number" id="num2_last_digit"><br>
          Number3 : <input type="number" id="num3_last_digit">
        </form>
    ...
    <p id="result_upper_lower"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter total marks : <input type="number" id="totalmarks_exam_status"><br>
          Enter last exam mark : <input type="number" id="exammk_exam_status">
        </form>
    ...
    <p id="result_exam_status"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_sortasum"><br>
          Number2 : <input type="number" id="num2_sortasum">
        </form>
    ...
    <p id="result_sortasum"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_check8"><br>
          Number2 : <input type="number" id="num2_check8">
        </form>
    ...
    <p id="result_check8"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_three_numbers"><br>
          Number2 : <input type="number" id="num2_three_numbers"><br>
          Number3 : <input type="number" id="num3_three_numbers">
        </form>
    ...
    <p id="result_three_numbers"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_number_order"><br>
          Number2 : <input type="number" id="num2_number_order"><br>
          Number3 : <input type="number" id="num3_number_order">
        </form>
    ...
    <p id="result_number_order"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_same_last_digit"><br>
          Number2 : <input type="number" id="num2_same_last_digit"><br>
          Number3 : <input type="number" id="num3_same_last_digit">
        </form>
    ...
    <p id="result_same_last_digit"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_lessby20_others"><br>
          Number2 : <input type="number" id="num2_lessby20_others"><br>
          Number3 : <input type="number" id="num3_lessby20_others">
        </form>
    ...
    <p id="result_lessby20_others"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_test_number"><br>
          Number2 : <input type="number" id="num2_test_number">
        </form>
    ...
    <p id="result_check_numbers1"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_test_digit"><br>
          Number2 : <input type="number" id="num2_test_digit">
        </form>
    ...
    <p id="result_equal_pt"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Number1 : <input type="number" id="num1_division_string"><br>
          Number2 : <input type="number" id="num2_division_string">
        </form>
    ...
    <p id="result_division_string"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter a Word : <input type="text" id="word_string_copies"><br>
          Enter a Number : <input type="number" id="num_string_copies">
        </form>
    ...
    <p id="result_without_first_end"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Word1 : <input type="text" id="word1_concatenate"><br>
          Enter Word2 : <input type="text" id="word2_concatenate">
        </form>
    ...
    <p id="result_middle_three"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Word1 : <input type="text" id="word1_str_con_cat"><br>
          Enter Word2 : <input type="text" id="word2_str_con_cat">
        </form>
    ...
    <p id="result_nop"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter a Word : <input type="text" id="word_two_string"><br>
          Enter a Number : <input type="number" id="num_two_string">
        </form>
    ...
    <p id="result_two_string"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Number1 : <input type="number" id="num1_sum_three"><br>
          Enter Number2 : <input type="number" id="num2_sum_three"><br>
          Enter Number3 : <input type="number" id="num3_sum_three">
        </form>
    ...
    <p id="result_sum_three"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Number1 : <input type="number" id="num1_rotate_elements_left"><br>
          Enter Number2 : <input type="number" id="num2_rotate_elements_left"><br>
          Enter Number3 : <input type="number" id="num3_rotate_elements_left">
        </form>
    ...
    <p id="result_rotate_elements_left"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Number1 : <input type="number" id="num1_add_two_int_without_carrying"><br>
          Enter Number2 : <input type="number" id="num2_add_two_int_without_carrying"><br>
        </form>
    ...
    <p id="result_change_case"></p>
      ...
      <div class="function1">
        ...
        <form class="form1" action="index.html" method="post">
          Enter Word1 : <input type="text" id="word1_rearrangement_characters"><br>
          Enter Word2 : <input type="text" id="word2_rearrangement_characters">
        </form>
...
<script src = "Function_console.js"> </script>
